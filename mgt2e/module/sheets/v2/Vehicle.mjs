...
export class MgT2eVehicleSheet extends MgT2eActorV2 {
    ...
    static PARTS = {
        main: {
            template: "systems/mgt2e-piggy/templates/actor/v2/vehicle/vehicle.html",
            scrollable: ['']
        },
        tabs: {
        ...
        description: {
            template: "systems/mgt2e-piggy/templates/actor/v2/vehicle/description.html",
            scrollable: ['']
        },
        design: {
            template: "systems/mgt2e-piggy/templates/actor/v2/vehicle/design.html",
            scrollable: [""],
            classes: ["vehicle-design-tab"],
        },
        combat: {
            template: "systems/mgt2e-piggy/templates/actor/v2/vehicle/combat.html",
            scrollable: ['']
        },
        crew: {
            template: "systems/mgt2e-piggy/templates/actor/v2/vehicle/crew.html",
            scrollable: ['']
        },
        equipment: {
            template: "systems/mgt2e-piggy/templates/actor/v2/vehicle/equipment.html",
            scrollable: ['']
        },
        footer: {
